...
_Target: Launch through first 2,000 MAU and £15k MRR_
...
_Trigger: Stage 1 thresholds breached. Target: 2,000–20,000 MAU, £15k–£75k MRR_
...
_Trigger: Stage 2 thresholds breached. Target: 20,000–200,000 MAU, £75k–£500k MRR_
...
_Trigger: Stage 3 thresholds breached or enterprise customer requirements. Target: 200,000+ MAU, £500k+ MRR_
...
const db = readPreference === 'replica' ? dbReadReplica : dbPrimary;
```
...
_This document is updated whenever a new infrastructure component is added, a stage upgrade is triggered, or architectural decisions change. All changes require a pull request with at least one approving review._
