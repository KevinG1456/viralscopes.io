...
> **Version:** 1.0
> **Last Updated:** 2026-07-31 (Phase 9 Billing — Milestone 5 of 6 complete: existing Phase 5 plan-limit checks now resolve subscription state live from the database instead of the JWT, plus a daily grace-period-expiry job — live-verified with real upgrade/downgrade/grace-period scenarios against a running backend, no live Stripe account exists yet)
> **Status:** Phase 9 — Subscription & Billing, Milestone 5/6 (Feature Enforcement) complete; see §2
...
| Property | Value |
|---|---|
| **Current phase** | Phase 9 — Subscription & Billing (Milestone 5/6 "Feature Enforcement" complete and live-verified; no emails yet — see §2) |
...
| **Last status update** | 2026-07-31 |
| **Next milestone** | M9 — Billing Live (Week 15): Milestones 1-4/6 done (Billing Foundation, Checkout & Subscription APIs, Webhooks, Frontend Billing); Milestone 5/6 (Feature Enforcement) next |
...
### In Progress: Phase 9 — Subscription & Billing (Milestone 5/6)
...
**Not done yet — by design, not oversight (Milestone 6+):** no billing emails, no invoice UI (no backing endpoint), no new quota-tracking infrastructure for `video_analyzed`/`api_request`/`export_created` (still blocked on TD-020/TD-025/TD-016 — none of their endpoints exist yet), no alert-channel restriction (no defined data shape or UI to enforce against yet).
...
Phase 9          █████████████████░░░   83%  🚧 Milestone 5/6 (Feature Enforcement) complete
...
| Phase 9 | Subscription & Billing | 🚧 In progress | 11/19 tasks (58%), Milestone 5/6 | Week 13–15 | Billing Foundation, Checkout & Subscription APIs, Stripe webhook processing, the frontend billing dashboard, and live feature enforcement all live-verified; no billing emails yet |
